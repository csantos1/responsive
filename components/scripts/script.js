jQuery(document).ready(function($) {
  ...
  if(!isTouch) {
	...
	var pin = new ScrollScene({
	  ...
	  .setTween(roomtween)
	  .addTo(controller);//#victoria
 }//not a touch device
	//attractions animation
	var attractionstween = TweenMax.staggerFrommTo('#attractions article', 1, {opacity: 0, scale: 0}, {delay: 1, opacity: 1, scale: 1, ease: Back.easeOut});
